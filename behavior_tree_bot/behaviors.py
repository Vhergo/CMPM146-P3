...
def spread_to_strongest_neutral_planet(state):
    ...
    if not strongest_planet or not strongest_neutral_planet:
        # No legal source or destination
        return False
    else:
        # (4) Send half the ships from my strongest planet to the weakest enemy planet.
        return issue_order(state, strongest_planet.ID, strongest_neutral_planet.ID, strongest_planet.num_ships / 2)